      ...
      {connectedAddress ? (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
          <div className="wallet-connected">
            ...
            <span className="wallet-address">
              Connected to VLADCHAIN via {getWalletIcon(connectedWalletType!)} {getWalletName(connectedWalletType!)}: {formatAddress(connectedAddress)}
            </span>
          </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
          <p className="wallet-connect-info">
            Connect your Web3 wallet to interact with the VLADCHAIN network
          </p>
          ...
          <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap' }}>
            <button
              ...
              style={{ 
                ...
                color: ethereumProvider ? '#CBFA03' : '#666',
                borderColor: ethereumProvider ? '#CBFA03' : '#333'
              }}
            >
              🦊 CONNECT METAMASK
            </button>
            ...
            <button
              ...
              style={{ 
                ...
                color: phantomProvider ? '#CBFA03' : '#666',
                borderColor: phantomProvider ? '#CBFA03' : '#333'
              }}
            >
              👻 CONNECT PHANTOM
            </button>
          ...
          <div className="wallet-support-info">
            Supported: MetaMask (Ethereum) and Phantom (Solana) for VLADCHAIN interaction
          </div>
        </div>
      )}
    </div>
