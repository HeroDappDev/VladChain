      ...
      {connectedAddress ? (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
          <div className="wallet-connected">
            ...
            <span className="wallet-address">
              Connected to VLADCHAIN via Phantom: {formatAddress(connectedAddress)}
            </span>
          </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
          <p className="wallet-connect-info">
            Connect your Phantom wallet to interact with the VLADCHAIN network
          </p>
          ...
          <div className="wallet-support-info">
            Phantom wallet for Solana-based VLADCHAIN interaction
          </div>
        </div>
      )}
    </div>
